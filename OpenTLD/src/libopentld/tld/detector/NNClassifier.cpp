...
float NNClassifier::classifyBB(const cv::ocl::oclMat &img, Rect *bb)
{
...
float NNClassifier::classifyWindow(const cv::ocl::oclMat &img, int windowIdx)
{
    NormalizedPatch patch;
...
bool NNClassifier::filter(const cv::ocl::oclMat &img, int windowIdx)
{
