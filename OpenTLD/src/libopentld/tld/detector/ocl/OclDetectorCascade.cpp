...
void OclDetectorCascade::propagateMembers()
{
...
void OclDetectorCascade::release()
{
    if(!initialised)
    {
        return; //Do nothing
...
void OclDetectorCascade::cleanPreviousData()
{
 ...
 *
 */
void OclDetectorCascade::initWindowsAndScales()
{
...
void OclDetectorCascade::initWindowOffsets()
{
...
void OclDetectorCascade::detect(const Mat &img)
{
