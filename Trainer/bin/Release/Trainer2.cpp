...
const char *NEG_IMAGES_DIR = "./neg/";
const char *NEG_IMAGES_FOLDER = "neg/";
//the file extention we use
const char *IMAGES_FORMAT = "*.jpg";
//the log file name
const char *LOG_FILE_NAME_POS = "./info.dat";
const char *LOG_FILE_NAME_NEG = "./bg.dat";
...
void saveNegImage() {
//construct a string based on the current file name, index and the mouse box rect
  string out = toString(NEG_IMAGES_FOLDER) + currentImageFile;
  ofstream myfile;
